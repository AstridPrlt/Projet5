            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        ...
                        Le {{ formatedDate(event.event_date) }}
                    </li>
                    <li class="list-group-item">
                        ...
                        De {{ formatedTime(event.begin_time) }} à {{ formatedTime(event.end_time) }}
                    </li>
                    <li class="list-group-item">
                    ...
                    <li class="list-group-item">
                        Places restantes : {{ event.seats - event.seats_booked }} / {{ event.seats }}
                    </li>
                </ul>
            <div class="card-body">
