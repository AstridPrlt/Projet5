...
<div class="w-75 m-auto pt-3">
    ...
    <div class="d-md-flex">
        ...
        <div class="col-12 col-md-4 mx-auto">
            <div class="mb-3">
                <svg width="4em" height="4em" viewBox="0 0 16 16" class="bi bi-wifi" style="width: 100%; color: lightseagreen;" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-12 col-md-4 mx-auto">
            <div class="mb-3">
                <svg width="4em" height="4em" viewBox="0 0 16 16" class="bi bi-cup-fill" style="width: 100%; color: lightseagreen;" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-12 col-md-4 mx-auto">
            <div class="mb-3">
                <svg width="4em" height="4em" viewBox="0 0 16 16" class="bi bi-clock-history" style="width: 100%; color: lightseagreen;" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
