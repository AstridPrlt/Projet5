...
@section('public_content')
    ...
    <div class="w-100">
        <div class="d-sm-flex bg-dark">
            ...
            <img class="col-12 col-sm-5 col-md-7 px-0" src="./../public/images/coffeeplace.jpg" alt="Photo du café">
        </div>
        ...
        <div class="d-sm-flex flex-sm-row-reverse bg-light">
            ...
            <img class="col-12 col-sm-5 col-md-7 px-0" src="./../public/images/events.jpg" alt="Photo d'un évènement">
        </div>
